...
const description = 'get the remgcn profile data.'
const options = [
    {
        name: 'vanityurl',
...
const fetchUserGameData = async (steamID) => {
    return new Promise((resolve, reject) => {
        request("https://raw.githubusercontent.com/MalikRemgcRegion/MalikRemgcRegion.github.io/main/db_remgcn/db/db.json", (err, res, body) => {
            if (err) {
                reject(err);
                return;
            }
...
const fetchAdditionalData = async (steamID) => {
    return new Promise((resolve, reject) => {
        request(`https://raw.githubusercontent.com/MalikRemgcRegion/MalikRemgcRegion.github.io/main/db_remgcn/ids/${steamID}.json`, (err, res, body) => {
            if (err) {
                reject(err);
                return;
            }
